...
namespace Unity.Simulation
{
    ...
    public class Configuration
    {
        ...
        /// <summary>
        /// Get or set the persistent data path when running locally.
        /// This property has no effect, when running in the cloud.
        /// </summary>
        public static string localPersistentDataPath { get; set; } = Application.persistentDataPath;
        ...
        public T GetAppParams<T>()
        {
            ...
            try
            {
                var filePath = new Uri(SimulationConfig.app_param_uri).LocalPath;
        ...
        {
            return IsSimulationRunningInCloud() ? SimulationConfig.storagePath : localPersistentDataPath;
        }
        ...
        {
            return IsSimulationRunningInCloud() ? SimulationConfig.storagePathOther : localPersistentDataPath;
        }
